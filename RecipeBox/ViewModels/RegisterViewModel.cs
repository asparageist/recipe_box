...
namespace RecipeBox.ViewModels
{
  public class RegisterViewModel
  {
    ...
    [RegularExpression("^[A-Za-z\\d@$!%*?&]{0,}$", ErrorMessage = "Your password must contain at least six characters, a capital letter, a lowercase letter, a number, and a special character.")]
